...
time python -tt ${SRC}/tester.py -f ${TESTS}/test1 -o ${OUT} -i 20; echo
time python -tt ${SRC}/tester.py -f ${TESTS}/test2 -o ${OUT} -i 20; echo
...
time python -tt ${SRC}/tester.py -t test9 -o ${OUT} -i 5; echo
time python -tt ${SRC}/tester.py -t test10 -o ${OUT} -i 5; echo
